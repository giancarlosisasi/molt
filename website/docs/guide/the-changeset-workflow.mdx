...
Molt does read commit history once, as a [migration aid](/guide/migrating-from-changesets), to
...
- [Adding a changeset](/guide/adding-a-changeset) -- a hands-on walkthrough of `molt add`.
