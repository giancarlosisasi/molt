"""`molt version` -- Consume changesets: bump versions, propagate, write changelogs.
...
#: Removing this flag turns on the ``tests/cli/test_version.py`` conformance suite -- the module's
...
def run(**options: Any) -> Any:
    """Report that `molt version` is not implemented yet, and exit non-zero.
    ...
    """
    not_implemented("version", options)
