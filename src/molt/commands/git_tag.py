...
#: Removing this flag turns on the ``tests/cli/test_git_tag.py`` conformance suite -- the module's
...
def run(**options: Any) -> Any:
    """Report that `molt git-tag` is not implemented yet, and exit non-zero.
    ...
    """
    not_implemented("git-tag", options)
